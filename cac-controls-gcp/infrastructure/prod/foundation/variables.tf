...
variable "exclude_folders" {
  ...
  type        = list(string)
  default     = []
  # default     = ["folders/720388851965"] //legacy folder
}
...
variable "allowed_resource_location" {
  description = "This list constraint defines location where resource will be created"
  type        = list(string)
...
variable "restrict_auth_types" {
  ...
  type        = list(string)
  default     = ["USER_ACCOUNT_HMAC_SIGNED_REQUESTS", "SERVICE_ACCOUNT_HMAC_SIGNED_REQUESTS"]
}
...
variable "allowed_export_destination" {
  ...
  type        = list(string)
  default     = ["under:organizations/102589584140", "under:organizations/911595324361"] //dev-td,pat-td org id 
}
...
variable "restrict_dedicated_interconnect_networks" {
  ...
  type        = list(string)
  default     = ["under:projects/prj-p-gcp-svpc-restricted-4395", "under:projects/prj-c-gcp-svpc-restricted-443e", "under:projects/prj-n-gcp-svpc-restricted-9105", "under:projects/prj-d-gcp-svpc-restricted-80cb"]
...
variable "restrict_partner_interconnect_networks" {
  ...
  type        = list(string)
  default     = ["under:projects/prj-p-gcp-svpc-restricted-4395", "under:projects/prj-n-gcp-svpc-restricted-9105", "under:projects/prj-d-gcp-svpc-restricted-80cb"]
}
...
variable "Vpc_Peering_Projects" {
  ...
  type        = list(string)
  default     = ["under:folders/391150242170", "under:projects/prj-p-gcp-svpc-restricted-4395", "under:projects/prj-c-gcp-svpc-restricted-443e", "under:projects/prj-n-gcp-svpc-restricted-9105", "under:projects/prj-d-gcp-svpc-restricted-80cb"]
}
