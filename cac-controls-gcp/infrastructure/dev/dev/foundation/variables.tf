...
variable "restrict_dedicated_interconnect_networks" {
  ...
  type        = list(string)
  default     = ["under:projects/prj-e-gcp-svpc-restricted-61d3"]
}
...
variable "restrict_Shared_Vpc_Backend_Services" {
  ...
  type        = list(string)
  default     = ["under:organizations/102589584140"]
}
...
variable "restrict_Shared_Vpc_Host_Projects" {
  ...
  type        = list(string)
  default     = ["under:projects/prj-c-gcp-svpc-restricted-b1f2", "under:projects/prj-e-gcp-svpc-restricted-61d3"]
}
...
variable "Vpc_Peering_Projects" {
  ...
  type        = list(string)
  default     = ["under:folders/391150242170", "under:projects/prj-c-gcp-svpc-restricted-b1f2", "under:projects/prj-e-gcp-svpc-restricted-61d3"]
}
